...
lstm_multi_path="ruthe_lstm_multi.nc"#"../Model/timetest/lstm_multi/output/temp/timetest_lstm_multitemp_24_24.nc"#"forecast_lstm_multi.nc"
lstm_multi_cor="ruthe_lstm_multi_red.nc"
...
wind_dir_50_cos=[]
wind_dir_50 = []
modellist=[baseline,references,lstm_uni,lstm_multi,lstm_multi_cor]
def tagesmax(data):
...
scores=pd.DataFrame({
    'Models': ["baseline","SARIMA","LSTN_UNI","LSTM_MULTI","LSTM_MULTI_COR"],
    'RMSE_temp':temps,
...
scores.to_csv("scores_paper_ruthe.csv")