...
if __name__ == '__main__':
    ...
    for forecast_var in forecast_vars:
        for window_size in tqdm([5*24,16*7*24]):#,8*7*24,4*7*24,2*7*24,7*24,6*24,4*24,3*24,2*24,24,12,6,3]):
            for forecast_horizont in [24,48,]:#2,4,6,12,15,18,24,32,48,60,72,84,96,192]:
                if window_size!=5*24 :
