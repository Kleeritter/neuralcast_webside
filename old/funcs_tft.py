...
class TFT_Modell(pl.LightningModule):
    def __init__(self, input_dim, output_dim, hidden_dim, num_layers, num_heads,dropout=0.1,forecast_horizont=24,window_size=24,forecast_var="temp",learning_rate=0.001, weight_decay=0.001,weight_initializer="normal"):
    ...
    def get_positional_encoding(self, d_model, max_len=672):#"cuda:0"):
    ...
    def initialize_weights(self):
        ...
        elif self.weight_initializer == 'kaiming':
            for name, param in self.named_parameters():
                if 'weight' in name:
